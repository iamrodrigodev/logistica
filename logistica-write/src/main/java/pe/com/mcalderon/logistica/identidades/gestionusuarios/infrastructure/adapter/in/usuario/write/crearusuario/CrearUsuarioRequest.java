...
public record CrearUsuarioRequest(
        ...
        @Positive(
                message = "El identificador de la persona debe ser mayor que cero"
        )
        Long personaId,
        ...
        @NotNull(
                message = "El actor de creación es obligatorio"
        )
        @Positive(
                message = "El actor de creación debe ser mayor que cero"
        )
